...
def generate_pedestrian_dataset(num_samples_per_type=50, trajectory_length=20):
    """
...
if __name__ == "__main__":
    ...
    plot_samples(pedestrian_trajectories[0], filename='constant_speed_normalized.png')
    plot_samples(pedestrian_trajectories[50], filename='constant_acc_normalized.png')
    # plot_samples(pedestrian_trajectories[20], filename='varying_speed_normalized.png')
    plot_samples(pedestrian_trajectories[100], filename='quadratic_traj_normalized.png')
    plot_samples(pedestrian_trajectories[150], filename='cubic_traj_normalized.png')
    plot_samples(pedestrian_trajectories[200], filename='sine_traj_normalized.png')
    plot_samples(pedestrian_trajectories[250], filename='cosine_traj_normalized.png')
    
    # Save the trajectory data as JSON
    save_trajectory_to_json(pedestrian_trajectories, "my_trajectory_data_normalized.json")
