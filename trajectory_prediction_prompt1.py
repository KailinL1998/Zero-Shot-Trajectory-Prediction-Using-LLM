...
def predict_trajectory_with_ollama(given_trajectory_steps, num_future_steps=12, model_name=""):
    ...
    few_shot_examples = """
    Input: 0  0,  5  5, 11 11, 16 16, 21 21, 26 26, 32 32, 37 37
    Output: 42 42, 47 47, 53 53, 58 58, 63 63, 68 68, 74 74, 79 79, 84 84, 89 89, 95 95, 100 100
    Input: 0  0,  5  5,  9  9, 14 14, 19 19, 23 23, 28 28, 33 33
    Output: 39 39, 44 44, 49 49, 54 54, 60 60, 65 65, 71 71, 77 77, 82 82, 88 88, 94 94, 100 100
    Input: 100  0, 100 13, 99 25, 98 37, 96 47, 93 57, 90 65, 86 73
    Output: 82 80, 78 85, 72 90, 66 94, 60 97, 53 99, 46 100, 38 100, 29 99, 20 97, 10 95,  0 91
    Input: 100 12, 100 24, 100 36, 100 48, 99 59, 98 69, 97 78, 95 86
    Output: 93 92, 89 97, 85 100, 81 100, 75 98, 68 94, 60 86, 51 76, 40 62, 28 45, 15 25,  0  0
    Input: 0 97, 13 100, 23 99, 27 93, 25 81, 21 68, 19 56, 21 49
    Output: 30 47, 43 50, 57 53, 67 53, 72 47, 71 36, 67 23, 64 10, 66  2, 74  0, 86  2, 100  5
    Input: 91  0, 92 10, 98 26, 100 37, 91 38, 75 32, 62 30, 61 38
    Output: 67 53, 71 66, 64 69, 48 64, 34 60, 30 66, 35 80, 41 95, 36 100, 22 96,  6 91,  0 94
    """

    prompt = f"""
    Given a sequence of 2D points representing a trajectory, where each point is formatted as a space-separated x y pair, and the pairs are separated by commas.
