...
def predict_trajectory_with_ollama(given_trajectory_steps, num_future_steps=12, model_name=""):
    ...
    Analyze the changes between consecutive points to identify any trends in movement, such as direction, speed, acceleration, curvature, or oscillation. Estimate the rule or function that best explains the past motion.
    Please predict the next {num_future_steps} future steps in this trajectory by continuing the pattern observed above.
